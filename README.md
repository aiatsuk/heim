...
| **files** | 30 |
| **size** | 598K |
| **updated** | 2026-07-30T07:13:59Z UTC |
| **history** | 13 samples in [`docs/metrics/`](docs/metrics/) |
...
|--------|------:|-------:|--------:|:-----:|
| **1d** (today) | `0` | `+112B` | `+43/−42` | yes |
| **3d** (3 days) | `+1,532` | `+81.8K` | `+3,072/−788` | yes |
| **1w** (1 week) | `+7,120` | `+598.8K` | `+13,636/−1,451` | since birth |
| **2w** (2 weeks) | `+7,120` | `+598.8K` | `+13,636/−1,451` | since birth |
| **1mo** (1 month) | `+7,120` | `+598.8K` | `+13,636/−1,451` | since birth |
| **2mo** (2 months) | `+7,120` | `+598.8K` | `+13,636/−1,451` | since birth |
| **6mo** (6 months) | `+7,120` | `+598.8K` | `+13,636/−1,451` | since birth |
| **1y** (1 year) | `+7,120` | `+598.8K` | `+13,636/−1,451` | since birth |
