...
| **files** | 30 |
| **size** | 601K |
| **updated** | 2026-09-07T12:39:37Z UTC |
| **history** | 52 samples in [`docs/metrics/`](docs/metrics/) |
...
| **3d** (3 days) | `0` | `+207B` | `+87/−85` | yes |
| **1w** (1 week) | `0` | `+566B` | `+306/−299` | yes |
| **2w** (2 weeks) | `0` | `+967B` | `+567/−554` | yes |
| **1mo** (1 month) | `0` | `+2.0K` | `+1,238/−1,209` | yes |
| **2mo** (2 months) | `+7,120` | `+601.4K` | `+15,301/−3,077` | since birth |
| **6mo** (6 months) | `+7,120` | `+601.4K` | `+15,301/−3,077` | since birth |
| **1y** (1 year) | `+7,120` | `+601.4K` | `+15,301/−3,077` | since birth |
