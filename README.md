...
| **files** | 30 |
| **size** | 600K |
| **updated** | 2026-08-27T17:40:32Z UTC |
| **history** | 41 samples in [`docs/metrics/`](docs/metrics/) |
...
|--------|------:|-------:|--------:|:-----:|
| **1d** (today) | `0` | `+55B` | `+0/−0` | yes |
| **3d** (3 days) | `0` | `+199B` | `+90/−88` | yes |
| **1w** (1 week) | `0` | `+486B` | `+257/−251` | yes |
| **2w** (2 weeks) | `0` | `+985B` | `+547/−534` | yes |
| **1mo** (1 month) | `0` | `+1.9K` | `+1,231/−1,202` | yes |
| **2mo** (2 months) | `+7,120` | `+600.6K` | `+14,824/−2,611` | since birth |
| **6mo** (6 months) | `+7,120` | `+600.6K` | `+14,824/−2,611` | since birth |
| **1y** (1 year) | `+7,120` | `+600.6K` | `+14,824/−2,611` | since birth |
