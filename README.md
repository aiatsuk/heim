...
| **files** | 30 |
| **size** | 599K |
| **updated** | 2026-08-10T08:06:48Z UTC |
| **history** | 24 samples in [`docs/metrics/`](docs/metrics/) |
...
|--------|------:|-------:|--------:|:-----:|
| **1d** (today) | `0` | `+69B` | `+0/−0` | yes |
| **3d** (3 days) | `0` | `+217B` | `+83/−81` | yes |
| **1w** (1 week) | `0` | `+464B` | `+254/−248` | yes |
| **2w** (2 weeks) | `+1,532` | `+82.4K` | `+3,501/−1,207` | yes |
| **1mo** (1 month) | `+7,120` | `+599.5K` | `+14,105/−1,909` | since birth |
| **2mo** (2 months) | `+7,120` | `+599.5K` | `+14,105/−1,909` | since birth |
| **6mo** (6 months) | `+7,120` | `+599.5K` | `+14,105/−1,909` | since birth |
| **1y** (1 year) | `+7,120` | `+599.5K` | `+14,105/−1,909` | since birth |
