...
def sample_with_heim(heim_bin: str) -> Sample:
...
def main() -> int:
    ...
    block = render_block(cur, rows, now, len(samples))
    ...
    print(
        f"metrics: samples={len(samples)} code={cur.code} "
